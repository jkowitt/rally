...
values
  ...
  ('comparison_callout', 'SponsorCX charges $15,000/year. Loud Legacy Pro is $199/month. Same category. 18 AI features they don''t have. 1/10th the price.', 'text', 'Callout box text', 'hero', 3),
...
values
  ('Why is Loud Legacy so much cheaper than SponsorCX?',
   'SponsorCX was built for an era before AI automation made it possible to dramatically reduce the cost of sophisticated software. We built Loud Legacy from the ground up with AI at the core, which means we can deliver more features at a fraction of the cost.',
   1),
  ('What are AI credits?',

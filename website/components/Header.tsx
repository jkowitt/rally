    ...
    <header className={`header rally-header ${scrolled ? 'scrolled' : ''}`}>
      <div className="container header-content">
        ...
        <nav className={`nav ${isOpen ? 'open' : ''}`}>
          {!isDashboard && (
            <>
              <Link href="/leagues" className={`nav-link ${pathname === '/leagues' ? 'active' : ''}`}>Leagues</Link>
              <Link href="/how-it-works" className={`nav-link ${pathname === '/how-it-works' ? 'active' : ''}`}>How It Works</Link>

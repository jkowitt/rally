...
function inferModule(pathname) {
  ...
  if (pathname.startsWith('/app/ops/newsletter')) return 'newsletter'
  if (pathname.startsWith('/app/ops/team')) return 'team'
  if (pathname.startsWith('/app/ops/automations')) return 'automations'
